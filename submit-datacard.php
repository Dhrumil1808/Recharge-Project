...
$i="INSERT INTO details_recharge(ID, Mobile_No, Type,Circle,Operator, Amount,userID,Date,Time,Balance) VALUES ('Null','$servicenumber','$p','$code','$q','$amount','$g','$date','$time','$e')";
mysql_query($i);
